...
function Navbarmobile() {
  ...
  return (
    <div className=' border-red-300 rounded-t-2xl shadow-lg md:hidden fixed min-h-[2.5rem] w-full  z-30 bg-gradient-to-r from-emerald-100 to-emerald-600 p-2 bottom-0 border-t-1 '>

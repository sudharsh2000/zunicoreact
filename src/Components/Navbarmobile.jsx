...
function Navbarmobile() {
  ...
  return (
    <div className='mx-2 border-red-300 rounded-2xl shadow-lg md:hidden fixed min-h-[2.5rem] w-full  z-50 bg-white p-2 bottom-0 border-t-1 '>
    <ul className=' flex  flex-row justify-between  items-center gap-[3.4rem]'>
        ...
        <li onClick={()=>navigate('/list?search=""')} className='flex flex-col justify-center  items-center gap-2'><Grid/> List </li>

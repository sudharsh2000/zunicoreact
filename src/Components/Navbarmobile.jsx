...
function Navbarmobile() {
  ...
  return (
    <div className='mx-2.5 border-red-300 rounded-2xl shadow-lg md:hidden sticky min-h-[2.5rem] w-fit  z-50 bg-white p-2 bottom-0 border-t-1 border-gray-400'>
    <ul className=' flex  flex-row justify-between  items-center gap-[3rem]'>

...
function Categories() {
  ...
  return (
    <div className=' rounded-sm gap-[1.9rem] md:gap-[6rem] my-5 py-3.5 px-[1rem] md:px-[4rem] flex-nowrap  flex flex-row justify-center items-center  bg-white overflow-x-auto  '>
 ...
 return <div key={categ.id} onClick={()=>navigate(`/list?category=${categ.id}`)} className=' flex justify-center flex-col items-center gap-1.5'>
            ...
            <h3 className='text-[9px] text-center md:text-[14px] text-black border-1 border-red-600 py-0.5 px-2.5  rounded-2xl hover:scale-110 cursor-pointer transform-3d transition-transform'>{categ.name}</h3>
